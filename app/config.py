...
class Settings(BaseSettings):
    service_role: str = "inference-gateway"
    service_name: str = "inference_gateway"
    service_title: str = "Inference gateway"
    service_description: str = "OpenAI-compatible dataplane gateway with security, quota, routing, cost and audit hooks."
